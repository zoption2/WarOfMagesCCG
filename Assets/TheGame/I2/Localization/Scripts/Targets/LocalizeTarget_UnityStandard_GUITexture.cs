...
namespace I2.Loc
{
    ...
    #endif
    public class LocalizeTarget_UnityStandard_Texture : LocalizeTarget<Texture>
    {
        static LocalizeTarget_UnityStandard_Texture() { AutoRegister(); }
        [RuntimeInitializeOnLoadMethod] static void AutoRegister() { LocalizationManager.RegisterTarget(new LocalizeTargetDesc_Type<Texture, LocalizeTarget_UnityStandard_Texture>() { Name = "Texture", Priority = 100 }); }
